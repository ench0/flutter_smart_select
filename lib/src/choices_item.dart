...
class ChoicesItem<T> extends StatelessWidget {
  ...
  ChoicesItem(this.data, this.type, this.config, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    // return widget
    return Consumer<SmartSelectStateSelected<T>>(builder: (context, state, _) {
          ...
          : (T value, [bool checked = true]) {
              state.select(value, checked, () {
                if (state.isMultiChoice != true) {
                  ...
                  bool isFiltering = Provider.of<SmartSelectStateFilter>(
                          context,
                          listen: false)
                      .activated;
        ...
        if (state.isMultiChoice == true) {
          ...
          if (choiceType == SmartSelectChoiceType.radios) {
            ...
            choiceWidget = FilterChip(
              ...
              backgroundColor: style.inactiveTrackColor ?? Colors.transparent,
              onSelected:
                  onSelect != null ? (_) => onSelect(data.value, true) : null,
              selected: isSelected,
            );
          }
        }
